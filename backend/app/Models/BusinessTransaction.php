...
{
    protected $fillable = ['type', 'action', 'account_id', 'price_rate', 'cost_rate', 'php_rate', 'cost_php_rate', 'price_gold', 'cost_gold', 'price_php', 'cost_php', 'profit_php', 'amount', 'description', 'date', 'notes', 'archived_at'];
