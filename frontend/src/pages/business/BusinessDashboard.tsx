          ...
          <div className="relative flex flex-col gap-4">
            ...
            <div className="flex items-start justify-between gap-4">
              <div>
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-[11px] font-semibold uppercase tracking-wider text-white/60">Initial Profit</span>
                </div>
                ...
                <p className="text-xs text-white/60 mt-1 flex items-center gap-1.5">
                  ...
                  <span className="font-semibold text-white/80">
                    <Amt value={formatCurrency(archivedProfit)} />
                  </span>
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3 pt-3 border-t border-white/20">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <p className="text-[10px] font-semibold uppercase tracking-wider text-white/50">Expense</p>
